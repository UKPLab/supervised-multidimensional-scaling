...
def chain_engine() -> SupervisedMDS:
    return SupervisedMDS(ComputedStage1(n_components=2, manifold=ChainShape(threshold=1.1)))
...
def disc_circular_engine() -> SupervisedMDS:
    return SupervisedMDS(ComputedStage1(n_components=2, manifold=DiscreteCircularShape(num_points=12)))
...
def circular_engine() -> SupervisedMDS:
    ...
    return SupervisedMDS(ComputedStage1(n_components=2, manifold=CircularShape(radious=1.0)))
...
def cylindrical_engine() -> SupervisedMDS:
    ...
    return SupervisedMDS(ComputedStage1(n_components=3, manifold=CylindricalShape(radius=1.0)))
...
def spherical_engine() -> SupervisedMDS:
    ...
    return SupervisedMDS(ComputedStage1(n_components=3, manifold=SphericalShape(radius=1.0)))
...
def geodesic_engine() -> SupervisedMDS:
    return SupervisedMDS(ComputedStage1(n_components=3, manifold=GeodesicShape(radius=1.0)))
...
def spiral_engine() -> SupervisedMDS:
    return SupervisedMDS(
        ComputedStage1(n_components=2, manifold=SpiralShape(initial_radius=0.5, growth_rate=1.0, num_turns=2.0))
    )
...
def euclidean_engine() -> SupervisedMDS:
    ...
    return SupervisedMDS(ComputedStage1(n_components=1, manifold=EuclideanShape()), alpha=0.1)
...
def semicircular_engine() -> SupervisedMDS:
    ...
    return SupervisedMDS(ComputedStage1(n_components=2, manifold=SemicircularShape()), alpha=0.1)
...
def klein_bottle_engine() -> SupervisedMDS:
    return SupervisedMDS(ComputedStage1(n_components=4, manifold=KleinBottleShape()), alpha=0.1)
