...
To import classes/methods of `supervised_multidimensional_scaling` from inside the package itself you can use relative imports: 
...
```py
from supervised_multidimensional_scaling import BaseClass # Notice how I omit the file name
from supervised_multidimensional_scaling.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `supervised_multidimensional_scaling` from command line:

```bash
$ python -m supervised_multidimensional_scaling
```
